...
NSComparisonResult compareViewDepth(UIView *view1, UIView *view2, CaruseolVIEW *self);

@end


@implementation CaruseolVIEW

- (NSUInteger)numberOfPlaceholdersInCarousel:(__unused CaruseolVIEW *)carousel { return 0; }
- (void)carouselWillBeginScrollingAnimation:(__unused CaruseolVIEW *)carousel {}
- (void)carouselDidEndScrollingAnimation:(__unused CaruseolVIEW *)carousel {}
- (void)carouselDidScroll:(__unused CaruseolVIEW *)carousel {}

- (void)carouselCurrentItemIndexDidChange:(__unused CaruseolVIEW *)carousel {}
- (void)carouselWillBeginDragging:(__unused CaruseolVIEW *)carousel {}
- (void)carouselDidEndDragging:(__unused CaruseolVIEW *)carousel willDecelerate:(__unused BOOL)decelerate {}
- (void)carouselWillBeginDecelerating:(__unused CaruseolVIEW *)carousel {}
- (void)carouselDidEndDecelerating:(__unused CaruseolVIEW *)carousel {}

- (BOOL)carousel:(__unused CaruseolVIEW *)carousel shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)carousel:(__unused CaruseolVIEW *)carousel didSelectItemAtIndex:(__unused NSInteger)index {}

- (CGFloat)carouselItemWidth:(__unused CaruseolVIEW *)carousel { return 0; }
- (CATransform3D)carousel:(__unused CaruseolVIEW *)carousel
   itemTransformForOffset:(__unused CGFloat)offset
            baseTransform:(CATransform3D)transform { return transform; }
- (CGFloat)carousel:(__unused CaruseolVIEW *)carousel
